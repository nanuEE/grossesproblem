...
return [
    ...
    'timestamp' => 1681653713,
    'checksum' => '3f04873e33152163542a6a73f26946ed',
    'files' => [
        ...
        'user/themes' => [
            ...
            'themes/crazy' => [
                'file' => 'user/themes/crazy/blueprints.yaml',
                'modified' => 1681651560
            ]
        ]
    ],
    'data' => [
        'items' => [
            ...
            'themes.crazy.dropdown' => [
                'type' => '_parent',
                'name' => 'themes.crazy.dropdown',
                'form_field' => false
            ],
            'themes.crazy.dropdown.enabled' => [
                'type' => 'toggle',
                ...
                'name' => 'themes.crazy.dropdown.enabled',
                'validation' => 'loose'
            ]
        ],
        'rules' => [
        ...
        'nested' => [
            ...
            'themes' => [
                ...
                'crazy' => [
                    'dropdown' => [
                        'enabled' => 'themes.crazy.dropdown.enabled'
                    ]
                ]
            ]
        ],
